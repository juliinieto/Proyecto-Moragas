...
# Cargar imágenes
fondo = pygame.image.load("imagenes/lugar.jpg").convert()
peppa = pygame.image.load("imagenes/peppe.png").convert_alpha()
peppa = pygame.transform.scale(peppa, (60, 60))

pelota = pygame.image.load("imagenes/burbuja.png").convert_alpha()
pelota = pygame.transform.scale(pelota, (34, 34))

# Cargar sonido
sonido_salto = pygame.mixer.Sound("sonidos/arriba.wav")
sonido_fin = pygame.mixer.Sound("sonidos/termino.wav")
